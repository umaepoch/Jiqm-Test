...
frappe.ui.form.on('Certificate of Conformance Print Format', {
...
frappe.ui.form.on("Certificate of Conformance Print Format", "refresh", function(frm, cdt, cdn) {
    console.log("Entered------");
...
frappe.ui.form.on("Certificate of Conformance Print Format", "quality_inspection_template", function(frm, cdt, cdn) {
    var qitemp_id = cur_frm.doc.quality_inspection_template;
    //var readings = fetch_cocpf_readings(cocpf_id);
    frappe.call({
        method: "jiqm_test.jiqm_test.doctype.certificate_of_conformance_print_format.certificate_of_conformance_print_format.fetch_quality_inpection_template_params",
        args: {
            "name": qitemp_id
        },
        async: false,
